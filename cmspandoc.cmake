...
MACRO(CONFIGUREPANDOCOLOGY)
  ...
  SET(PANDOC_DOCUMENTCLASS "article" CACHE STRING "Document class with Latex")
  SET(PANDOC_LANGUAGE de-DE CACHE STRING "Language with BCP 47 identifier")
  SET(PANDOC_LATEX_ENGINE pdflatex CACHE STRING "Latex engine")
  ...
  SET(PANDOC_FONT_MAIN "Helvetica" CACHE STRING "Font")
  SET(PANDOC_FONT_MONO "Helvetica" CACHE STRING "Font")
  SET(PANDOC_INCLUDE_CONTENT TRUE CACHE BOOL "Choose if you want include Tables of content (toc)")
  SET(PANDOC_INCLUDE_FIGURE FALSE CACHE BOOL "Choose if you want include Tables of figures (lof)")
  SET(PANDOC_INCLUDE_TABLE FALSE CACHE BOOL "Choose if you want include Tables of tables (lot)")
  SET(PANDOC_SECTION_NUMBERS yes CACHE STRING "Add section numbers")
  ...
  SET_PROPERTY(CACHE PANDOC_LANGUAGE PROPERTY STRINGS en-US de-DE)
  ...
  LIST(APPEND PANDOC_FONTS "Helvetica" "Liberation Sans" "Inconsolata" "FreeMono" "Palatino")
